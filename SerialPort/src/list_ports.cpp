...
glob(const std::vector<std::string>& patterns)
{
...
std::string
usb_sysfs_friendly_name(const std::string& sys_usb_path)
{
...
std::vector<std::string>
get_sysfs_info(const std::string& device_path)
{
...
std::string
read_line(const std::string& file)
{
